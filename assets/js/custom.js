...
<html lang="en">
  ...
  <body>
    ...
    `
            ...
            mailPayload.append(
              "subject",
              `MBA Internship Program with Salary, Cloud ECS Infotech`
            );
            mailPayload.append(
              "htmlContent",
              `
  ...
  <body>
    <div class="container">
      ...
      <div class="message">
        <h4 style="margin: 3rem 0 0 0;">Dear ${payload.first_name},</h4>
        <p style="margin: 3rem 0 0 0;">
          Thank you for your application to our MBA Internship Program with Salary!
        </p>
        <p style="margin: 2rem 0 0 0;">
          To stay updated on your upcoming sessions, please join our official Cloud ECS Infotech Pvt Ltd WhatsApp channel. Here, you'll receive important updates and information regarding the course.
        </p>
        ...
        <p style="margin: 3px 0 0 0;">
          🔗 <a href="https://whatsapp.com/channel/0029Vb02mW160eBaf2P9UQ2y">https://whatsapp.com/channel/0029VazH0d7BlHpUQDF9Ou2P</a> 
        </p>
        <p style="margin: 3rem 0 0 0;">
          We look forward to having you with us!
        </p>
